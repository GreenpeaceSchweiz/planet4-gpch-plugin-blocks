...
if ( ! class_exists( 'Controller' ) ) {
    ...
    abstract class Controller {
        ...
        public function load() {
            ...
            add_action( 'wp_ajax_P4CHBKS_preview_render_' . static::BLOCK_NAME, [ $this, 'prepare_admin_preview' ] );
        }
        ...
        public function prepare_template_preview_iframe( $fields, $content, $shortcode_tag ) {
            $preview_args   = [
                ...
                '_content' => $content,
                '_post_id' => get_the_ID(),
                '_nonce'   => wp_create_nonce( 'P4CHBKS_preview_render_' . static::BLOCK_NAME ),
                'action'   => 'P4CHBKS_preview_render_' . static::BLOCK_NAME,
            ];
        ...
        public function prepare_admin_preview() {
            ...
            if ( ! wp_verify_nonce( $_GET['_nonce'], 'P4CHBKS_preview_render_' . static::BLOCK_NAME ) ) {
                exit;
            }
        ...
        protected function get_template( $template ) {
            ...
            $template = P4CHBKS_PLUGIN_DIR . '/admin/templates/' . $template . '.tpl.php';
